...
import { CreateCustomerDto, UpdateCustomerDto, UpdateLoyaltyPointsDto, SearchCustomerDto } from './dto/customer.dto';
...
export class CustomersService {
    ...
    async create(dto: CreateCustomerDto) {
        ...
        await this.eventEmitter.emit('customer.created', {
    ...
    async updateLoyaltyPoints(id: string, dto: UpdateLoyaltyPointsDto) {
        ...
        await this.eventEmitter.emit('customer.loyalty.updated', {
            customerId: id,
